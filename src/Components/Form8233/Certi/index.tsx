  ...
  return (
    ...
    <div style={{ padding: "20px" }}>
      ...
      >
        ...
        <Paper style={{marginLeft: "20px", padding: "10px" ,border:"2px solid black",fontSize:"20px"}} className="my-3">
<span style={{backgroundColor:"darkgrey", padding: "10px"}}>Part III</span>  Certification
    </Paper> 
        ...
        <Divider style={{marginTop:"1rem",marginBottom:"1rem",backgroundColor:"black"}}/>
          ...
          <Typography style={{ display: "flex" }}>
            ...
            <Typography
              style={{ fontSize: "20px", color: "black", marginTop: "7px" }}
            >
            4. Furthermore, I authorize this form to be provided to any withholding agent that has control, receipt, or custody of the income of which I am the beneficial owner or any withholding agent that can disburse or make payments of the income of which I am the beneficial owner.
            </Typography>
          </Typography>
          <Divider style={{marginTop:"1rem",marginBottom:"1rem",backgroundColor:"black"}}/>
