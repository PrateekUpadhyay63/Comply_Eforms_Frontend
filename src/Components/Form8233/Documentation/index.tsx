...
export default function Tin(props: any) {
    ...
    return (
                ...
                <Paper style={{ padding: "18px" }}>
                    ...
                    >
                        ...
                        <span><Tooltip style={{ backgroundColor: "black", color: "white" }} title={
                                        <>
                                            <Typography color="inherit">8233 Supporting Documentation</Typography>
                    ...
                    {toolInfo === "basic" ? (<div>
                        ...
                        style={{ margin: "10px", fontSize: "20px" }}>
                                There are no mandatory documents required for this submission
                                </Typography>

                                <Typography style={{ margin: "10px",fontSize: "33px", fontWeight: "550" }}>
                    ...
                    <div
                      ...
                      style={{
                        ...
                        justifyContent: "space-between",
                               ...
                               <Input style={{ fontSize: '19px',border:"none" }} type='file' />
     ...
     <DeleteOutline style={{color:'red',fontSize:"30px"}}/>
                        ...
                        <div  style={{ margin: "10px",marginLeft:"20px",marginTop:"1rem"}}>
                        <Button onClick={addIncomeType} variant="contained" style={{backgroundColor:"black"}}>
                        Add Additional Documentation
                        </Button>
                            </div>
