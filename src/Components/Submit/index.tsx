  ...
  return (
    ...
    <Paper style={{padding:"22px"}}>
            <form>
              {
                <Typography
                  align="left"
                  style={{ fontSize: '26px', color: '#04506e',fontWeight:"bold" }}
                >
      ...
      <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
        ...
        <AccordionDetails>
        <Paper elevation={3} style={{ padding: '20px',backgroundColor:'#d4d9d4',height:"280px" ,overflow:"auto"}}>
          <Typography align='left' style={{color:"black",fontWeight:"bold",fontSize:"18px",width:"100%"}}>
          Electronic Submission Declaration
          </Typography>

          <Typography align='left' style={{fontSize:"15px",marginTop:"13px"}}>
          ...
          <Typography align='left' style={{fontSize:"20px",marginTop:"13px",fontWeight:"bold"}}>
To Confirm:
          </Typography>
          ...
          <Typography align='left' style={{fontSize:"20px",marginTop:"13px"}}>
      ...
      <Accordion expanded={expanded === 'panel2'} onChange={handleChange('panel2')}>
        <AccordionSummary
          ...
          id="panel2bh-header"
        >
          <Typography sx={{ width: '100%', flexShrink: 0 ,fontSize:"20px"}}>Electronic Recipient Statement</Typography>
         
        </AccordionSummary>
        <AccordionDetails>
         <Paper elevation={3} style={{ padding: '20px',backgroundColor:'#d4d9d4' }}>
            <Divider style={{marginTop:"10px",color:"black"}}/>
         <Typography style={{color:"black",fontWeight:"bold",fontSize:"16px",marginTop:"10px"}}>
