...
// <Typography align='left' style={{ margin: '10px',fontSize:"27px" ,fontWeight:'550'}}>Part II Certification<span style={{ color: 'red' }}>*</span>
//                       </Typography>
//                       <Typography  align='left'style={{ margin: '10px',fontSize:"27px" ,fontWeight:'550'}}>W-8ECI Electronic Substitute F Statement</Typography>
//                       <Typography align='left' style={{ margin: '10px',fontSize:"19px", color:"grey"}}>
...
//       <Checkbox/>
//       <Typography style={{fontSize:'19px',color:'black'}}>
