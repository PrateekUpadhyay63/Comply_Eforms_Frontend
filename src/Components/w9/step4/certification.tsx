...
<span><Tooltip style={{ backgroundColor: "black", color: "white" }} title={
                            <>
                              <Typography color="inherit">Legal certification details</Typography>
                          ...
                          <Paper style={{ backgroundColor: "#dedcb1", padding: '15px', marginBottom: "10px" }}>
                            <Typography>
                            Legal certification details: This form must be signed and dated to establish to the requester or withholding agent that you are a U.S. person or a valid resident alien. Note that our system requires an electronic signature to confirm electronic submission.
                            </Typography>
                           
                            <Typography style={{ marginTop: "10px" }}>Requirement for signature:
                            </Typography>
                            <Typography style={{ marginTop: "10px" }}>
                              
You may be requested to sign your submission by the withholding agent or requester, even if indicated otherwise below. Please note that this electronic forms submission process requires a valid electronic signature in all cases. Signature requirements: Complete the certification as indicated in 1 through 5 below.
                            </Typography>
                            <Typography style={{ marginTop: "10px" }}>
                            1. For interest, dividend, and barter exchange accounts opened before 1984 and broker accounts considered active during 1983, you must give your correct TIN, but you do not have to sign the certification.
                            </Typography>
                            <Typography style={{ marginTop: "10px" }}>2. For interest, dividend, broker, and barter exchange accounts opened after 1983 and broker accounts considered inactive during 1983, you must sign the certification or backup withholding will apply. If you are subject to backup withholding and you are only providing your correct TIN to the requester, select either (i) an appropriate box in 2; or (ii) box 3.
                              </Typography>
...
5. Mortgage interest paid by you, acquisition or abandonment of secured property, cancellation of debt, qualified tuition program payments (under Section 529), IRA, Coverdell ESA, Archer MSA or HSA contributions or distributions, and pension distributions. You must give your correct TIN, but you do not have to sign the certification.
                      ...
                      <Typography style={{ margin: '10px',fontSize:"18px", color:"grey",marginLeft:"20px"}}>
...
<Paper  style={{ marginLeft: '20px', width: '80%',backgroundColor:"#d2d6d3" }}>
  <div style={{margin:'10px'}}>
    <Typography style={{display:"flex"}}>
      <Checkbox/>
      <Typography style={{fontSize:'15px',color:'black',marginTop:'11px'}}>
    ...
    <Typography style={{display:"flex"}}>
      ...
      3. I am a U.S. citizen or other U.S. person (See Glossary of Terms for a definition of a U.S. person), and
    ...
    <Typography style={{display:"flex"}}>
      <Checkbox/>
      <Typography style={{fontSize:'15px',color:'black',marginTop:'11px'}}>
      4. The FATCA code(s) entered on this form (if any) indicate that I am exempt from FATCA reporting is correct.
      </Typography>
    </Typography>
   
    <Typography style={{fontSize:'13px',color:'black',marginTop:"10px",marginBottom:"20px"}}>Please check the box below if you have been notified by the IRS that you are currently subject to backup withholding because you have failed to report all interest and dividends on your tax return. For real estate transactions, item 2 does not apply.For mortgage interest paid, acquisition or abandonment of secured property, cancellation of debt, contributions to an individual retirement arrangement (IRA), and generally, payments other than interest and dividends, you are not required to sign the Certification, but you must provide your correct TIN. <span style={{fontWeight:"bold"}}>(Please note e-submission through this service requires an e-signature)</span></Typography>
    <Typography style={{display:"flex"}}>
      <Checkbox/>
      <Typography style={{fontSize:'15px',color:'black',marginTop:'11px'}}>
      I have been notified by IRS that I am currently subject to backup withholding.
      </Typography>
    </Typography>
    <Typography style={{display:"flex"}}>
      <Checkbox/>
