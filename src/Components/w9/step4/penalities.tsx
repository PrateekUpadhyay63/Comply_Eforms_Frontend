...
import {FormControl,Typography,Button, Input,Paper,Checkbox,Tooltip,Link} from '@mui/material'
...
<Typography align='left' style={{ margin: '10px',fontSize:"20px" ,fontWeight:'550'}}>Part II Certification<span style={{ color: 'red' }}>*</span>
                      ...
                      <div  style={{margin:'20px',display:"flex",marginTop:"20px",width:"70%",justifyContent:"space-between"}}>
                       <div>
                      ...
                      <Input
                        ...
                        style={{
                          ...
                          padding: ' 0 10px ',}}
                       />
                       <span style={{fontSize:"12px",color:"blue",marginLeft:"10px"}}>Recover Password</span>
